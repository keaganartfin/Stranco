        ...
        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
          ...
          >
            ...
            <li className="flex items-center">
                <a
                  className="hover:text-slate-500 dark:hover:text-slate-100 text-slate-700 dark:text-slate-300 px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold"
                  href="/"
                  target="_blank"
                >

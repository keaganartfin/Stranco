import FullBuilding from "assets/img/FullBuilding.jpg";
    ...
    <>
      <div className="container mx-auto">
        <div className="flex flex-wrap items-center">
          <div className="px-0 ml-auto mr-auto -mt-32 w-full md:w-6/12 lg:w-4/12 md:px-4">
            <div className="relative flex flex-col w-full min-w-0 mb-6 break-words bg-white rounded-lg shadow-lg dark:bg-slate-900">
              ...
              <blockquote className="relative p-8 mb-4">
                ...
                <p className="mt-2 font-bold text-md text-slate-500 dark:text-slate-400">
                  Since 1944, Stranco Products has grown to the largest
                  distributor of heat-shrinkable tubing products and electrical
                  insulation in the Midwest. Stranco Products is certified to
                  both ISO 9000 and QS-9000 certifications since November
                  2004...
                </p>
                <a
                  className="text-sm flex justify-end underline underline-offset-4 text-sky-500"
                  href="/about"
                >
                  Read More...
                </a>
                ...
                <div className="relative flex flex-col min-w-0">
                  <div className="flex-auto px-4 py-5">
                    ...
                    <p className="mb-4 font-semibold text-slate-500">
                      ...
                      is to to work with Notus React.
                    </p>
                  </div>
                </div>
              </div>

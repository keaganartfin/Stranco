...
const ProductInfo = () => {
  ...
  const dataS = { SubProductInfo };
  const ProductData = dataP.SpecificProductInfo;
  const SubProductData = dataS.SubProductInfo;
  console.log(ProductData[id]);
  return (
    <div>
      <section className="bg-white dark:bg-black dark:bg-opacity-20 py-6 sm:py-12 pt-16">
        <div className="container px-6 py-10 mx-auto">
            ...
            <div className="w-full space-y-12 lg:w-1/2 ">
              ...
              <div className="md:flex md:items-start md:-mx-4">
                <div className="mt-4 md:mx-4 md:mt-0">
                  <p className="mt-3 text-lg text-gray-500 dark:text-gray-300 w-9/12">
                    {ProductData[id].description.paragraph1}
                  </p>

                  <div className="sm:-ml-8 mt-10">
                    <h3 className="text-xl font-semibold text-gray-800 capitalize lg:text-2xl dark:text-white">
                      {ProductData[id].description.header2}
                      <div className="-mt-1">
                        <span className="inline-block w-40 h-1 bg-blue-500 rounded-full"></span>
                        <span className="inline-block w-3 h-1 ml-1 bg-blue-500 rounded-full"></span>
                        <span className="inline-block w-1 h-1 ml-1 bg-blue-500 rounded-full"></span>
                  ...
                  <p className="mt-3 text-lg text-gray-500 dark:text-gray-300 w-9/12">
                    {ProductData[id].description.paragraph2}
                  </p>
                </div>
              </div>
            </div>
          ...
          <hr className="my-24 border-gray-500 dark:border-sky-700" />

...
const Contact = () => {
  return (
    <div>
      <IndexNavbar />
      <div className="min-h-screen py-32 p-6 bg-gray-100 dark:bg-slate-900 flex items-center justify-center">
        <div className="container max-w-screen-lg mx-auto">
          <div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded shadow-xl p-8 md:p-8 mb-6">
